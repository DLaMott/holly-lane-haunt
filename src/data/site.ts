...
export const scenes: Scene[] = [
  ...
  { number: 8, name: "Seventh Circus of Hell", description: "Ringmasters, red light, and performers who never actually clocked out.", photoKey: "ringmaster" },
  ...
  { number: 10, name: "Silent Woods", description: "The trail goes quiet here. Too quiet. Whatever's watching from the trees knows better than to make a sound.", photoKey: "woods" },
