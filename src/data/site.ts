...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer: "Yes, candy is handed out at the end of the trail during halloween.",
  },
  {
...
export const scenes: Scene[] = [
  { number: 1, name: "Crowley's Crypt", description: "The gates to the Crowley family mausoleum, your welcome into Holly Lane, guarded by a pair of very unfriendly gargoyles.", photoKey: "crowley" },
  { number: 2, name: "Graveside Hollow", description: "A fog-choked hollow of leaning headstones, where the ground doesn't feel done settling.", photoKey: "graveside" },
  { number: 3, name: "Swamp Water Cauldron", description: "A bubbling backwoods cauldron deep in the muck, tended by something that's been stirring far too long.", photoKey: "witch" },
  { number: 4, name: "Suicide By Spider", description: "Web after web after web. Turning back means admitting defeat. Pressing on means finding out what's spinning them.", photoKey: "spider" },
  { number: 5, name: "Electrocution Alley", description: "Buzzing wires, sparking fixtures, and a corridor that hums louder the deeper you go.", photoKey: "electrocution" },
  { number: 6, name: "The House of Horror", description: "Step into the blacklight clown maze, where everything glows and nothing is where you think it is.", photoKey: "house_horror" },
  { number: 7, name: "Derry Sewer System", description: "Down where the pipes echo, something's been waiting in the dark since long before you got here.", photoKey: "derry" },
  { number: 8, name: "Seventh Circus of Hell", description: "Ringmasters, red lights, and performers who never actually clocked out.", photoKey: "ringmaster" },
  { number: 9, name: "Insidious", description: "The lights flicker, the shadows don't match the room, and something's been following you since the entrance.", photoKey: "insidious" },
  { number: 10, name: "Silent Woods", description: "The trail goes quiet here. Too quiet. Whatever's watching from the trees knows better than to make a sound.\n PS: Don't whistle here..", photoKey: "woods" },
  { number: 11, name: "Gabe's Chop Shop", description: "A working butcher shop that stopped asking where the meat comes from a long time ago. Gabe just keeps sharpening.", photoKey: "gabes" },
  { number: 12, name: "LaMott Industries", description: "A research lab that spent years dissecting things that shouldn't exist. Containment didn't hold, and neither did the specimens.", photoKey: "lamott_industries" },
  { number: 13, name: "NEW FOR 2026 (CLASSIFIED)", description: "Under construction and top secret. The name isn't out yet, but the crew building it hasn't slept much this fall.", photoKey: "new_scene" },
  { number: 14, name: "NEW FOR 2026 (CLASSIFIED)", description: "What lies beyond the entrance remains a secret until opening night.", photoKey: "new_scene" },
];
